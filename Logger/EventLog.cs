...
public static bool CustomErrorRoutine(Exception objException)
{
	...
	if (true != WriteErrorToLog(strPathName,objException))
	{
		bReturn	= false;
	}
	return bReturn;
...
public static bool CustomMessageRoutine(string message)
{
    string strPathName = string.Empty;
    if (strLogFilePath.Equals(string.Empty))
    {
    ...
    bool bReturn = true;
    // write the error log to that text file
    if (true != WriteMessageToLog(strPathName, message))
    {
        bReturn = false;
    }
    return bReturn;
...
/// <param name="objException"></param>
/// <returns>false if the problem persists</returns>
public static bool WriteErrorToLog(string strPathName,Exception  objException)
{
	bool bReturn		= false;
...
public static bool WriteMessageToLog(string strPathName, string message)
{
    bool bReturn = false;
    string strException = string.Empty;
    try
